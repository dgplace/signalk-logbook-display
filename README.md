...
- Voyages are grouped by inactivity gaps over 36 hours, while legs split on anchored gaps (>= 1 hour) so legs can span multiple days and multiple legs can occur within a single day.
